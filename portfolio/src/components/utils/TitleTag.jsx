...
const TitleTag = ({ tilte, dotsColor, bgColor }) => {
  return (
    <div className="relative w-32 h-18 md:w-64 md:h-24 lg:w-96 lg:h-40">
      <DotsPattern
        color={dotsColor}
      ...
      <div className="flex items-center h-14 md:h-20 lg:h-32">
        <div
          className={`${bgColor} absolute inset-0  z-0 w-30 h-14 md:w-56 md:h-20 lg:w-80 lg:h-32 border-t-4 md:border-t-8 lg:border-t-10 `}
